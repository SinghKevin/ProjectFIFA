...
class ShootSearch(object):
    ...
    def __init__(self):
        ...
        team1.add("Expe",RandomStrategy())
        team2 = SoccerTeam("test2")
        team2.add("Nothing",GardienStrategy())
        team2.add("cible",CampeurStrategy_1())
    ...
    def begin_round(self,team1,team2,state):
        ...
        self.simu.state.states[(2,0)].position = Vector2D(145,45)
        self.simu.state.states[(2,1)].position = Vector2D(70,65)
        self.simu.state.states[(1,0)].vitesse = Vector2D()
        self.simu.state.ball.position = Vector2D(120,45)
